...
<body>
    <div class="cover-container d-flex w-100 h-100 p-1 mx-auto flex-column">
        ...
        <h5 class="h5">Excluir Usuario</h5>
        ...
        if (isset($_POST['deletar'])) {
            ...
            if ($banco->query($sql)) {
                echo msg_sucesso("Usuario deletado com sucesso!");
            } else {
                echo msg_erro("Não foi possivel deletar o Usuario");
            }
        } else {
            require "excluir-user-form.php";
        }
        ?>
        <br>
        <?php echo voltar() ?>
